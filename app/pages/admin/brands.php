<?php
    ...
    $brand_res = mysqli_query($db, "SELECT * FROM brands LIMIT $start, $limit");
    $brands = mysqli_fetch_all($brand_res, MYSQLI_ASSOC);
    ...
    <table class="white-space-nowrap w-full h-auto min-w-100 table-collapse">
        ...
        <tbody>
            ...
            <tr class="w-full h-auto justify-content-start">
                ...
                <td class="p-8 w-max justify-content-start align-items-center start-text border-solid border-wb-1 border-w-0 border-slate-100 dark:border-slate-800"><?php echo $brand['brand_name'] ; ?></td>
                <td class="p-8 w-max justify-content-start align-items-center start-text border-solid border-wb-1 border-w-0 border-slate-100 dark:border-slate-800"><?php echo date('d F, Y', strtotime($brand['date'])) ; ?></td>
                <td class="p-8 w-max justify-content-start align-items-center start-text border-solid border-wb-1 border-w-0 border-slate-100 dark:border-slate-800">
                    <div style="display: flex; flex-direction: row; gap: .6rem;">
                        <a href="edit_brands/<?php echo str_to_url($brand['brand_name']); ?>" class="d-flex align-items-center justify-content-center p-8 bg-orange-500 hover:bg-orange-600 active:bg-orange-400 color-white border-round-md">
                        ...
                        <a class="d-flex align-items-center justify-content-center p-8 bg-red-500 hover:bg-red-700 active:bg-red-400 color-white border-round-md delete-category" data-category="<?php echo $brand['brand_name'] ?>">
